...
const translations: Record<Language, Translations> = {
  UA: {
    ...
    checkout: {
      ...
      euOnlyDelivery: 'Доставка тільки по країнах ЄС. Для медіа-запитів звертайтесь на email.',
  ...
  EN: {
    ...
    checkout: {
      ...
      euOnlyDelivery: 'Delivery only to EU countries. For media inquiries, please contact us via email.',
  ...
  newsletter: {
    ...
    checkout: {
      ...
      euOnlyDelivery: 'Lieferung nur in EU-Länder. Für Medienanfragen kontaktieren Sie uns bitte per E-Mail.',
  ...
  PL: {
    ...
    checkout: {
      ...
      euOnlyDelivery: 'Dostawa tylko do krajów UE. W sprawach medialnych prosimy o kontakt e-mailowy.',
  ...
  SE: {
    ...
    checkout: {
      ...
      euOnlyDelivery: 'Leverans endast till EU-länder. För medieförfrågningar, vänligen kontakta oss via e-post.',
  ...
  NO: {
    ...
    checkout: {
      ...
      euOnlyDelivery: 'Levering kun til EU-land. For mediehenvendelser, vennligst kontakt oss via e-post.',
  ...
  DK: {
    ...
    checkout: {
      ...
      euOnlyDelivery: 'Levering kun til EU-lande. For mediehenvendelser, kontakt os venligst via e-mail.',
      deliveryMethod: 'Leveringsmetode',
      inpostLabel: 'InPost Paczkomat',
  ...
  FR: {
    ...
    checkout: {
      ...
      euOnlyDelivery: 'Livraison uniquement dans les pays de l\'UE. Pour les demandes médias, veuillez nous contacter par e-mail.',
