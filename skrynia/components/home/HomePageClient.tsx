...
export default function HomePageClient() {
    ...
    try {
      ...
      if (res.ok) {
        ...
        const transformedProducts: Product[] = data.map((product) => ({
          ...
          title: getProductTitle(product, language),
  ...
  const homePageJsonLd = {
    ...
    '@id': `${siteUrl}/#webpage`,
    url: siteUrl,
    name: 'Rune Box - Authentic Handmade Jewelry',
      ...
      <section className="py-20 md:py-32 px-4 bg-footer-black" aria-labelledby="featured-products-title">
        <div className="container mx-auto">
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12" role="list" aria-label="Featured products">
            ...
            <div className="text-center py-20">
              <p className="text-sage font-inter">No featured products at the moment</p>
            </div>
          )}
        ...
        <div className="container mx-auto relative z-10">
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <aside aria-label="Benefits of buying from us">
