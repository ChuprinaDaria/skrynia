      ...
      <div className="container mx-auto relative z-10">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-8">
            <h2 className="font-cinzel text-3xl md:text-4xl text-ivory mb-4">
              Отримуйте Магічні Пропозиції
            </h2>
            <p className="font-inter text-sage text-base md:text-lg">
              Підпишіться на розсилку та дізнавайтеся першими про нові колекції та ексклюзивні знижки
            </p>
          </div>
          ...
          {!isSubmitted ? (
            ...
            <div className="text-center py-8 bg-deep-black border border-sage/30 rounded-sm animate-fade-in">
              ...
              <p className="text-sage text-sm">
                Перевірте свою пошту для підтвердження
              </p>
            </div>
          )}
          ...
          <p className="text-center text-sage/60 text-xs mt-6 font-inter">
            Ми поважаємо вашу конфіденційність. Відписатися можна будь-коли.
          </p>
