    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-sage/20">
          <h2 id="cart-title" className="font-cinzel text-2xl text-ivory">
            Кошик
          </h2>
          <button
            onClick={onClose}
        ...
        <div className="flex-grow overflow-y-auto p-6">
          {items.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center">
              ...
              <h3 className="font-cinzel text-xl text-ivory mb-2">Кошик порожній</h3>
              <p className="text-sage font-inter mb-6">
                Додайте прикраси, щоб продовжити покупки
              </p>
              ...
              {items.map((item) => (
                ...
                >
                  ...
                  <div className="flex-grow">
                    <h3 className="font-cinzel text-ivory text-base mb-2 line-clamp-2">
                      {item.title}
                    </h3>
          ...
          <div className="border-t border-sage/20 p-6 bg-deep-black/50">
            ...
            <div className="space-y-3 mb-6">
              <div className="flex justify-between font-inter text-sm">
                <span className="text-sage">Проміжний підсумок</span>
              ...
              <div className="flex justify-between font-inter text-lg">
                <span className="text-ivory font-semibold">Разом</span>
            ...
            {shipping > 0 && subtotal < 1000 && (
              <div className="mb-4 p-3 bg-oxblood/10 border border-oxblood/30 rounded-sm">
                <p className="text-sage text-xs font-inter text-center">
                  Додайте ще {1000 - subtotal} zł для безкоштовної доставки
                </p>
              </div>
            )}
